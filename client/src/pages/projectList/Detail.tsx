    ...
    <>
      <main>
        ...
        <section className={classes.detail}>
          <h2>
            여기는 프로젝트 제목이 들어가는 부분입니다. 제목이 만약에 두 줄
            이상이 되면 여기서 이렇게 내려갑니다.
          </h2>
          ...
          <div className={classes.description}>
            ...
            <div>
              ...
              placeholder 또는 가이드로 제시하면 좋을 것 같습니다. 프로젝트
              목표, 진행상황, 현재 팀 멤버, 최소한의 예상 기능 등
              중앙선거관리위원회는 법령의 범위안에서 선거관리·국민투표관리 또는
              정당사무에 관한 규칙을 제정할 수 있으며, 법률에 저촉되지 아니하는
              범위안에서 내부규율에 관한 규칙을 제정할 수 있다. 평화통일정책의
              수립에 관한 대통령의 자문에 응하기 위하여 민주평화통일자문회의를
              둘 수 있다. 국가는 전통문화의 계승·발전과 민족문화의 창달에
              노력하여야 한다. 대통령으로 선거될 수 있는 자는 국회의원의
              피선거권이 있고 선거일 현재 40세에 달하여야 한다. 국회의원은
              법률이 정하는 직을 겸할 수 없다. 대통령은 법률이 정하는 바에
              의하여 훈장 기타의 영전을 수여한다.
            </div>
          </div>
